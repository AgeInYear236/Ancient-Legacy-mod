...
namespace AncientLegacyMod.Content.Items.Neutrals.Tier2
{
    public class Vambrace : ModItem
    {
        // 0 - STR, 1 - AGI, 2 - INT
        public int mode = 0;
        ...
        {
            string modeName = mode == 0 ? Language.GetTextValue("Mods.AncientLegacyMod.Neutral.Vambrace.Mode0")
                : mode == 1 ? Language.GetTextValue("Mods.AncientLegacyMod.Neutral.Vambrace.Mode1")
                : Language.GetTextValue("Mods.AncientLegacyMod.Neutral.Vambrace.Mode2");
            Color modeColor = mode == 0 ? Color.Red : mode == 1 ? Color.Green : Color.Blue;

            var line = new TooltipLine(Mod, "Mode", Language.GetTextValue("Mods.AncientLegacyMod.Neutral.Vambrace.ModeText") + $"{modeName}");
